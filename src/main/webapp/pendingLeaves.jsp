    ...
    <table id="leaveTable">
        ...
        <%
            ...
            try {
                ...
                String query = "SELECT * FROM LeaveRequests WHERE final_status = 'Pending'";
                rs = stmt.executeQuery(query);

                while(rs.next()) {
        %>
        <tr id="row-<%= rs.getInt("leave_id") %>">
            ...
            <td>
                <a href="leaveDetails.jsp?leave_id=<%= rs.getInt("leave_id") %>&role=admin" class="btn">View Info</a>
            </td>
        </tr>
        <%
                }
