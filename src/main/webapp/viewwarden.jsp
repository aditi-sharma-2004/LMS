...
<head>
    ...
    <title>Warden Details - LMS</title>
    <style>
        body {
        ...
        <div class="nav-links">
            ...
            <%
                ...
                if (email != null && !email.trim().isEmpty()) {
                    try {
                        ...
                        // Fetch warden details with hostel name
                        String query = "SELECT w.*, h.name AS hostel_name FROM wardens w " +
                                       "LEFT JOIN Hostels h ON w.hostel_id = h.hostel_id WHERE w.email = ?";
            ...
            <div class="details-container">
                ...
                <div class="row">
                    ...
                    <div class="value"><%= rs.getString("warden_id") %></div>
                </div>
                ...
                <div class="row">
                    <label>Hostel:</label>
                    <div class="value"><%= rs.getString("hostel_name") != null ? rs.getString("hostel_name") : "N/A" %></div>
                </div>
