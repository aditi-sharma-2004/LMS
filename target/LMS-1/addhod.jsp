...
<body>
    ...
    <div class="container">
        <h1>Add HOD</h1>
        <form id="hodForm" action="UploadHodServlet" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="name">HOD Name:</label>
                <input type="text" id="name" name="name" placeholder="Enter HOD's name" required>
            </div>

            <div class="form-group">
                <label for="email">Email Address:</label>
                <input type="email" id="email" name="email" placeholder="Enter HOD's email" required>
            </div>
