        ...
        <div class="table-wrapper">
            <table id="leaveTable">
                ...
                // Get the HOD's department from the session
                    ...
                    if (sess == null || sess.getAttribute("hodDepartmentId") == null) {
                    ...
                    try {
                        ...
                        // Modified query to filter leave requests by department
                        PreparedStatement pstmt = con.prepareStatement(
                        "SELECT lr.leave_id, lr.student_id, s.name, lr.start_date, lr.end_date, lr.reason " + 
                        "FROM LeaveRequests lr " +
                        "JOIN Students s ON lr.student_id = s.student_id " +
                        "WHERE lr.warden_status = 'Accepted' " +
                        "AND lr.verification_status = 'Accepted' " + 
                ...
                <tr>
                    ...
                    <td>
                        <a href="leaveDetails.jsp?leave_id=<%= rs.getInt("leave_id") %>&role=hod" class="btn">View Info</a>
                    </td>
                </tr>
                <% 
                        }
