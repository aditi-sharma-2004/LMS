...
<%
    ...
    ResultSet rs = null;
    String base64Image = "default-profile.jpg"; // Default image path

    String email = request.getParameter("GPOEmailInput");
    ...
    if (email != null && !email.trim().isEmpty()) {
        try {
            ...
            String query = "SELECT * FROM gpo WHERE email = ?";
...
<div class="container">
    <div class="photo-container">
        <img src="<%= base64Image %>" alt="GPO Photo">
    </div>
    ...
    <div class="details-container">
        ...
        <div class="row">
            <label>GPO ID:</label>
            <div class="value"><%= rs.getString("gpo_id") %></div>
        </div>
...
<%
                ...
                out.println("<p style='color: red;'>No GPO found with this email!</p>");
            }
        } catch (Exception e) {
