...
// Check if not already in session, and see if it's passed via URL
    if (wardenId == null) {
        wardenId = request.getParameter("wardenId");
        if (wardenId != null) {
            session.setAttribute("wardenId", wardenId); // Save to session
        }
    }
    ...
    if (wardenId == null) {
        ...
        return;
            ...
            <%
                    ...
                    out.println("<tr><td colspan='6' style='color:red;'>Error loading leave data: " + e.getMessage() + "</td></tr>");
                    e.printStackTrace();
                } finally {
